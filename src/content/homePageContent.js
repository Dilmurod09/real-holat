...
export const HOME_PAGE_CONTENT = {
  ...
  hero: {
    ...
    description:
      '«Realholat.uz Решаем вместе» — приложение для решения проблем. Подавайте жалобы, задавайте вопросы, вносите предложения, участвуйте в опросах и голосованиях, чтобы повышать качество жизни. Это просто и быстро.',
    primaryAction: {
    ...
    stats: {
      items: [
        ...
        },
        {
          icon: 'active',
          value: '0',
          label: 'участвовавших пользователей',
          tone: 'light',
        },
      ],
      api: {
...
- Найдите школу через поиск;
- Нажмите «Оставить жалобу»;
- Сделайте фото или загрузите из галереи;
- Опишите проблему;
- Отправьте одним кликом.

— Через карту:
- Откройте карту школ;
- Нажмите на нужную школу;
