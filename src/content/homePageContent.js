...
export const HOME_PAGE_CONTENT = {
  ...
  schoolsTable: {
    id: 'schools-table',
    columns: ['Номер', 'Название', 'Задача', 'Регион', 'Рейтинг'],
    rows: [
      {
        num: 1,
        name: 'Школа 45',
